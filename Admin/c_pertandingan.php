                ...
                <li class="nav-item">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="c_pertandingan.php">Chart Pertandingan</a>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php  
                                                        include('koneksi.php');
                                                        $sql = "SELECT COUNT(id_jadwal) as total_pertandingan from tb_jadwal";
                                                        $query = mysqli_query($koneksi, $sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['total_pertandingan'],0,".",",");
                                                        }
                                                    ?>  
                                                </div>
                                            </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Total Jumlah Stadion</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    include('koneksi.php');
                                                    $sql = "SELECT COUNT(DISTINCT stadion) as jumlah_stadion from tb_jadwal";
                                                    $query = mysqli_query($koneksi,$sql);
                                                    while($row2=mysqli_fetch_array($query)){
                                                        echo number_format($row2['jumlah_stadion'],0,".",",");
                                                    }
                                                ?>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    <!-- Chart Jumlah Pertandingan Setiap Tanggal -->
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Jumlah Pertandingan Setiap Tanggal</h6>
                                    </div>
                                    <!-- Grafiknya -->
                                    <div class="card-body">
                                        <?php
                                            include('koneksi.php');
                                            $jadwal = mysqli_query($koneksi,"SELECT DISTINCT (tanggal) AS total FROM tb_jadwal");
                                            while($row = mysqli_fetch_array($jadwal)){
                                                $tanggal[] = $row['total'];
                                                $query = mysqli_query($koneksi,"SELECT COUNT(id_jadwal) AS pertandingan FROM tb_jadwal WHERE tanggal = '" . $row['total'] . "'");
                                                $row = $query->fetch_array();
                                                $tot_jadwal[] = $row['pertandingan'];
                                            }
                                        ?>
                                        <div>
                                            ...
                                            <script>
                                                ...
                                                var myChart1 = new Chart(ctx1, {
                                                    ...
                                                    data: {
                                                        ...
                                                        datasets: [{
                                                            label: 'Total Pertandingan perTanggal',
                                                            data: <?php echo json_encode($tot_jadwal); ?>,
